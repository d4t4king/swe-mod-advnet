...
$advnetsettings{'ENABLE_NOPING_RED'} = 'off';
$advnetsettings{'ENABLE_NOPING_GREEN'} = 'off';
$advnetsettings{'ENABLE_NOPING_PURPLE'} = 'off';
$advnetsettings{'ENABLE_NOPING_ORANGE'} = 'off';
...
if ($advnetsettings{'ACTION'} eq $tr{'save'}) {
	&writehash("${swroot}/mods/mod-advnet/settings", \%advnetsettings);
...
&readhash("${swroot}/mods/mod-advnet/settings", \%advnetsettings);

$checked{'ENABLE_NOPING'}{'off'} = '';
$checked{'ENABLE_NOPING'}{'on'} = '';
$checked{'ENABLE_NOPING'}{$advnetsettings{'ENABLE_NOPING'}} = 'CHECKED';

$checked{'ENABLE_NOPING_RED'}{'off'} = '';
$checked{'ENABLE_NOPING_RED'}{'on'} = '';
$checked{'ENABLE_NOPING_RED'}{$advnetsettings{'ENABLE_NOPING'}} = 'CHECKED';

$checked{'ENABLE_NOPING_GREEN'}{'off'} = '';
$checked{'ENABLE_NOPING_GREEN'}{'on'} = '';
$checked{'ENABLE_NOPING_GREEN'}{$advnetsettings{'ENABLE_NOPING'}} = 'CHECKED';

$checked{'ENABLE_NOPING_PURPLE'}{'off'} = '';
$checked{'ENABLE_NOPING_PURPLE'}{'on'} = '';
$checked{'ENABLE_NOPING_PURPLE'}{$advnetsettings{'ENABLE_NOPING'}} = 'CHECKED';

$checked{'ENABLE_NOPING_ORANGE'}{'off'} = '';
$checked{'ENABLE_NOPING_ORANGE'}{'on'} = '';
$checked{'ENABLE_NOPING_ORANGE'}{$advnetsettings{'ENABLE_NOPING'}} = 'CHECKED';
...
<tr>
	<td style='width:38%;' class='base'>$tr{'block icmp ping green'}</td>
	<td style='width:12%;'><input type='checkbox' style='vertical-align:middle' name='ENABLE_NOPING_GREEN' $checked{'ENABLE_NOPING_GREEN'}{'on'}></td>
...
<tr>
	<td style='width:38%;' class='base'>$tr{'block icmp ping red'}</td>
	<td style='width:12%;'><input type='checkbox' style='vertical-align:middle' name='ENABLE_NOPING_RED' $checked{'ENABLE_NOPING_RED'}{'on'}></td>
